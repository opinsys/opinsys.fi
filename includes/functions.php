...
function responsive_post_meta_data() {
  ...
  printf( __( '%2$s<span class="%3$s">', 'responsive' ),
  ...
  if ( !is_home() && !is_front_page() || is_paged() ) {
    ...
    function responsive_widgets_init() {
        ...
        register_sidebar(array(
            ...
            'before_title' => '<h3>',
            'after_title' => '</h3>',
            'before_widget' => '<div class="widget-wrapper widget_page_in_widget_custom"><div class="textwidget"><div class="home-widget-wrap">',
